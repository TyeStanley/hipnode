  ...
  return (
    ...
    >
      <svg
        ...
        height="22"
        viewBox="0 0 22 22"
        className="fill-dark-2 stroke-dark-2 dark:fill-light dark:stroke-light"
        xmlns="http://www.w3.org/2000/svg"
      >
        <path
          className="fill-light  stroke-light dark:fill-dark-2 dark:stroke-dark-2"
